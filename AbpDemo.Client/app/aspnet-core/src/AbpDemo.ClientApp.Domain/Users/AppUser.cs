...
namespace AbpDemo.ClientApp.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ClientAppDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ClientAppEfCoreEntityExtensionMappings to extend the IdentityUser entity
