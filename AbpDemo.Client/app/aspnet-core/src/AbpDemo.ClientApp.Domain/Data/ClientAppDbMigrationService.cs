...
{
    public class ClientAppDbMigrationService : ITransientDependency
    {
        public ILogger<ClientAppDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IClientAppDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public ClientAppDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IClientAppDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<ClientAppDbMigrationService>.Instance;
        }
